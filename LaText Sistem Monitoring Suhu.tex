...
Walaupun Rust bukan bahasa pemrograman Object Oriented Programming (OOP) murni seperti Java atau C++, Rust tetap mendukung konsep OOP melalui penggunaan struct, impl, dan method.

Pada project sistem monitoring suhu industri ini digunakan beberapa objek utama yaitu:
...
Struct Sensor digunakan untuk menyimpan informasi sensor suhu seperti nama sensor dan nilai suhu yang terbaca.
...
\subsection{Foto Hasil Percobaan}

Berikut merupakan hasil percobaan program monitoring suhu pada terminal.

\begin{center}
\includegraphics[width=0.9\textwidth]{gambarperc.jpeg}
\end{center}
